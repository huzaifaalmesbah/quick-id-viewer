...
Quickly view and copy post, page, and custom post type IDs directly from the admin list view with a single click.
...
1. Upload the 'quick-id-viewer' folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to Settings > Quick ID Viewer to configure which post types should display IDs
...
2. Settings page with card-based post type selection
3. One-click copy action demonstration
