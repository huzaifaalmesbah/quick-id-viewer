                ...
                <div class="qidvw-card">
                    <div class="qidvw-card-content">
                        <div class="qidvw-card-title">
                            <label for="qidvw_post_type_<?php echo esc_attr($post_type->name); ?>">
                                <?php echo esc_html($post_type->label); ?>
                            </label>
                            <span class="qidvw-card-type"><?php echo esc_html($post_type->name); ?></span>
                        </div>
                        <div class="qidvw-card-toggle">
                            <label class="qidvw-switch">
                                <input type="checkbox"
                                       ...
                                       id="qidvw_post_type_<?php echo esc_attr($post_type->name); ?>"
